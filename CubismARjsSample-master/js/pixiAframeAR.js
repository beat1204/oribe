...
//			motions.push(animation.fromMotion3Json(resources['motion9'].data));
		...
		var p1 = new Promise(function (resolve, reject) {
			...
			loader.add('model3', "assets/rakurai2AR/rakurai2AR.model3.json", xhrType);
			loader.add('motion1', "assets/rakurai2AR/byebye.motion3.json", xhrType);
			loader.add('motion2', "assets/rakurai2AR/wink.motion3.json", xhrType);
